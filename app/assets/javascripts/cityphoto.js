    ...
    geocoder.geocode( { 'address': suitcase.destination }, function(results, status) {
      if (status == google.maps.GeocoderStatus.OK) {
        ...
        // after getting the lat and long, use this in the ajax request to google to receive a photo reference
          $.ajax({
            url: 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + coordinates + '&radius=5000&key=AIzaSyAEmJ_uxarY1GFaiWbHvyX-AEkOK90rdyU',
            method: 'GET',
            data: {},
            dataType: 'JSON',
            headers : {'Access-Control-Allow-Origin': 'http://localhost3000'}
