  ...
  // making ajax call for post after city/country choice is defined
    // if ('#suitcase_duration' && '#country' && '#city'){
            $.ajax({
              ...
              var one = $('<a class="each-suitcase" href="http://pack-app.herokuapp.com/suitcases/' + suitcase.id +  '" >' + '<img src="https://s3-us-west-2.amazonaws.com/packapp/assets/suitcase1.png">' + '</a>');
