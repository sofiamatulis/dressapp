  ...
  //creating a new wardrobe! when clicking on the button new wardrobe and appending it to the list
    ...
    $('#new_wardrobe').on('submit',function(event){
      ...
      $.ajax({
        ...
        var link = $('<a class="name-wardrobe" href="http://pack-app.herokuapp.com/' + wardrobe.id +  '" >' + '<img src="https://s3-us-west-2.amazonaws.com/packapp/assets/mainwardrobe.png">' + '</a>');
